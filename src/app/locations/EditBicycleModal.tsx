            ...
            <div className="modal-dialog modal-dialog-centered modal-lg">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Edit Bicycle Station</h5>
                    ...
                    <div className="modal-body">
                        <div className="row">
                            <div className="col-md-6">
                                ...
                                <div className="mb-3">
                                    ...
                                    <select
                                        ...
                                        value={editData.bicycleType || "electric"}
                                ...
                                <div className="mb-3">
                                    <label className="form-label">Bicycle Status</label>
                                    <select
                                        className="form-select"
                                        value={editData.bicycleStatus || "available"}
                                        onChange={(e) => onUpdateField("bicycleStatus", e.target.value)}
                                    >
                            ...
                            <div className="col-md-6">
                                ...
                                />
                                <small className="text-muted">Click on the map to change the bicycle location</small>
                            </div>
                        </div>
                    </div>
